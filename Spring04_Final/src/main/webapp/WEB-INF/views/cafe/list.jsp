	...
	<div class="container">
		...
		<script>
			document.querySelectorAll(".pagination a").forEach(function(item){
				// item 은 li 의 참조값이다. 모든 a 요소에 mouseover 이벤트가 발생했을때 실행할 함수 등록
				item.addEventListener("mouseover" , function(e){
					// 애니메이션 클래스를 추가해서 애니메이션이 동작
					e.target.classList.add("animate__swing");
				});
				// item 은 li 의 참조값이다. 모든 a 요소에 animationed 이벤트가 발생했을때 실행할 함수 등록
				item.addEventListener("animationed" , function(e){
					// 애니메이션 클래스를 제거해서 다음번에 추가하면 다시 애니메이션이 동작
